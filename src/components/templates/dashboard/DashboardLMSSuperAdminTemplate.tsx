...
import { navigateToAddDonationScreen, navigateToDashboardLMSCountsDetailScreen, navigateToDocumentShareWithWhatsApp, navigateToDonationScreen, navigateToEventsScreen, navigateToMandirPhotosScreen, navigateToMandirScreen, navigateToMembersScreen, navigateToPhotoGalleryScreen, navigateToProjectDocuments, navigateToVideoGalleryScreen, navigateToVipPassScreen } from '../../../shared/Routes';
...
export default function DashboardLMSSuperAdminTemplate(props: DashboardLMSTemplateProps) {
        ...
        <View style={styles.container}>
            ...
            <View style={[styles.bodyContainer, { marginTop: 20 }]}>
                ...
                <View style={styles.bodyRow}>
                    <MyGradiantCard onPress={() => navigateToMandirScreen(navigation, ScreenNames.DASHBOARD)} gradiantColors={['#74EBD5', '#ACD7F2']} containerStyle={{ marginRight: 15 }}>
                        <View style={styles.cardContent}>
                            <View>
                                <Text style={styles.bodyCardText}>Registration</Text>
                                {
                                    isLoading &&
                    ...
                    <MyGradiantCard onPress={() => navigateToMembersScreen(navigation, ScreenNames.DASHBOARD)} gradiantColors={['#FF6B6B', '#FFD6AD']} >
                        <View style={styles.cardContent}>
                            {/* <Ionicons name="calendar-outline" size={32} color="white" style={styles.icon} /> */}
                            <View>
                                <Text style={styles.bodyCardText}>Member</Text>
                ...
                <View style={[styles.bodyRow, { marginTop: 5 }]}>
                    <MyGradiantCard onPress={() => navigateToDonationScreen(navigation, ScreenNames.DASHBOARDMALE)} gradiantColors={['#8E54E9', '#4776E6']} containerStyle={{ marginRight: 15 }}>
                        <View style={styles.cardContent}>
                            <View>
                                <Text style={styles.bodyCardText}>Donation</Text>
                                {
                                    isLoading &&
                                    <LoaderIcon style={{ padding: 10 }} color={"#fff"} size={"small"} />
                                }
                    ...
                    <MyGradiantCard onPress={() => navigateToVipPassScreen(navigation, ScreenNames.DASHBOARDFEMALE)} gradiantColors={['#FF68B8', '#8D3DAF']} >
                        <View style={styles.cardContent}>
                ...
                <View style={[styles.bodyRow, { marginTop: 5 }]}>
                    <MyGradiantCard onPress={() => navigateToEventsScreen(navigation, ScreenNames.DASHBOARD)}
                        ...
                        <View style={styles.cardContent}>
                            <View>
                                <Text style={styles.bodyCardText}>Events</Text>
                    ...
                    <MyGradiantCard  onPress={() => navigateToMandirPhotosScreen(navigation, ScreenNames.DASHBOARD)}
                        ...
                        <View style={styles.cardContent}>
                            <View>
                                ...
                                <MyText style={[styles.bodyCardText, GlobalStyles.m10]}>Temple Photos</MyText>
                                {
                                    isLoading &&
                                    <LoaderIcon style={{ padding: 10 }} color={"#fff"} size={"small"} />
                                }
                ...
                <View style={[styles.bodyRow, { marginTop: 5 }]}>
                    <MyGradiantCard onPress={() => navigateToPhotoGalleryScreen(navigation, ScreenNames.DASHBOARD)}
                         gradiantColors={['#4CAF50', '#40E0D0']} containerStyle={{ marginRight: 15 }}>
                        <View style={styles.cardContent}>
                            <View>
