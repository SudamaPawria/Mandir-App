...
import DashboardLMSSuperAdminTemplate from '../../components/templates/dashboard/DashboardLMSSuperAdminTemplate';

export default function DashboardLMSSuperAdminScreen(props: DashboardScreenProps) {
    ...
    return <DashboardLMSSuperAdminTemplate
        counts={counts}
