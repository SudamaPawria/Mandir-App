...
import { Delete_Event, GetAllEvents } from "../../services/EventsService";

const EventsScreen = (props: BaseProps) => {
    ...
    return (
        <View style={{ flex: 1, paddingHorizontal: 5, }}>
            <View style={styles.container}>
                ...
                <View style={{flex:1,  }}>
                    <EventsTemplate listData={itemsToDisplay} navigation={navigation} isSuperAdmin={isSuperAdmin}/>
                </View>
            </View>
