...
type Props = {
  navigation: StackNavigationProp<StackParamList, 'EventDetailsScreenPublic'>;
  route: RouteProp<StackParamList, 'EventDetailsScreenPublic'>;
};

const EventDetailsScreenPublic = (props: Props) => {
...
export default EventDetailsScreenPublic;
